 ...
 * @param freeElement - Function pointer to be used for removing element elements from
 *     the set.
				   ...
				   CompareASElements compareElements)
{
	...
	new_as->copyElement = copyElement;
	new_as->freeElement = freeElement;
	new_as->compareElements = compareElements;
	new_as->size=0;
	return new_as;
}
